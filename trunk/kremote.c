...
void action (char cmd, int shift) {
	...
	if (mode==KAFFEINE) {
		switch (cmd) {
			//Basic controls
			case 'P': command="dcop kaffeine KaffeineIface play"; break;
			case 'S': command="dcop kaffeine KaffeineIface stop"; break;
			case 'p': command="dcop kaffeine KaffeineIface pause"; break;
			case 'J': command="dcop kaffeine KaffeineIface quit"; break;//Not sure if have to keep that
			
			//Position
			case '<': command="dcop kaffeine KaffeineIface previous"; break;
			case '>': command="dcop kaffeine KaffeineIface next"; break;
			case '«': command="dcop kaffeine KaffeineIface posMinus"; break;
			case '»': command="dcop kaffeine KaffeineIface posPlus"; break;
			
			//Volume
			case '+': command="dcop kaffeine KaffeineIface volUp"; break;
			case '-': command="dcop kaffeine KaffeineIface volDown"; break;
			case 'M': command="dcop kaffeine KaffeineIface mute"; break;
			
			//Screen
			case 'F': command="dcop kaffeine KaffeineIface fullscreen"; break;
		...
		switch (cmd) {
			...
			case 'M': command="dcop amarok player mute"; break;
			
			//Basic controls
			case 'P': command="dcop amarok player playPause"; break;
			case 'S': command="dcop amarok player stop"; break;
			case 'p': command="dcop amarok player playPause"; break;
			case 'J': command="dcop amarok MainApplication-Interface quit"; break;//Not sure if have to keep that
